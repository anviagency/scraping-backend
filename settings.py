...
DATABASES = {
    'default': {
        ...
        'NAME': env('DB_NAME', default='scraping_db'),
        'USER': env('DB_USER', default='scraping_user'),
        'PASSWORD': env('DB_PASSWORD', default='@Klmn1357'),
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL', default='noreply@scraping.co.il')
